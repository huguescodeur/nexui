    ...
    console.print(
        Panel(
            "\n".join([
                ...
                "",
                "  2. In your base.html, add these lines inside <head>:",
                "",
                "     [cyan]{% load static %}",
                "     [cyan]<link rel=\"stylesheet\" href=\"{% static 'css/nexui.css' %}\">",
                "     [cyan]<script src=\"https://cdn.tailwindcss.com\"></script>",
                "     [cyan]<script>",
                "       tailwind.config = {",
                "         theme: { extend: { colors: {",
                ...
                "     </script>[/cyan]",
                "",
                "  3. Before </body>, add Alpine.js (needed for modal, dropdown, tabs, toast):",
                "",
                "     [cyan]<body x-data>",
                "       ...",
